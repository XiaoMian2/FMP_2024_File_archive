...
<head>
    ...
    <title> WangYiZhuo S1554654 - About Us </title>
    ...
    <div class="container">
        <div class="row">
            <div class="hidden-xs col-sm-4 col-md-4 col-lg-4">
                <div class="thumbnail">
                    <video src="videos/promotion.mp4" controls></video>
                </div>
            </div>
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                <blockquote class="blockquote-reverse">
                    <p>"Melbourne Public Library is an institution dating back to 1929. We have a range
                        of books, CDs, DVDs, magazines as well as a large range of downloadable content."
                    </p>
                    <footer>Melbourne Public Library</footer>
                </blockquote>
            </div>
        </div>
    </div>
